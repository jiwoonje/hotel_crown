...
(function() {
    (function(a, b, c) {
        ...
        d.prototype.init = function() {
            ...
            "undefined" != typeof TouchEvent && (a.data(this, "touch", !0),
            ...
            a.each(Array(this.data.total), function(b) {
                var c, d;
                return c = a("<li>", {
        ...
        d.prototype.play = function(b) {
            ...
            this.options.play.swap) ? (a(".slidesjs-play", c).hide(),
        ...
        d.prototype.stop = function(b) {
            ...
            this.options.play.swap ? (a(".slidesjs-stop", c).hide(),
            a(".slidesjs-play", c).show()) : void 0
        }
        ,
        d.prototype._slide = function(b) {
            ...
            return c = a(this.element),
            this.data = a.data(this),
            this.data.animating || b === this.data.current + 1 ? void 0 : (a.data(this, "animating", !0),
            d = this.data.current,
            b > -1 ? (b -= 1,
            l = b > d ? 1 : -1,
        ...
        d.prototype._fade = function(b) {
            ...
            f.children(":eq(" + e + ")").stop().fadeIn(this.options.effect.fade.speed, function() {
        ...
        d.prototype._getVendorPrefix = function() {
            var a, b, d, e, f;
            for (a = c.body || c.documentElement,
            d = a.style,
            e = "transition",
